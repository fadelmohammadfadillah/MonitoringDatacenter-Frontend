      ...
      <v-card>
        <v-card-text class="py-2">
          ...
          <v-container>
            ...
            <div v-if="divData.log === 'Normal'" class="text-normal">
              Normal
            </div>
            <div
              v-else
